...
func systemPack() packs.Pack {
	return packs.Pack{
		...
		Rules: []packs.Rule{
			{ID: "csrutil-disable", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Disabling SIP weakens core OS protections", Remediation: "Do not disable SIP", Match: packs.And(packs.Name("csrutil"), packs.ArgAt(0, "disable"))},
			{ID: "diskutil-erase", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Disk erase/repartition causes irreversible data loss", Remediation: "Do not erase or repartition disks", Match: packs.And(
				packs.Name("diskutil"),
				packs.Or(
			...
			{ID: "launchctl-remove", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Removing/disabling/killing launch services can break system behavior", Remediation: "Do not modify launch services", Match: packs.And(
			...
			{ID: "nvram-clear", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Clearing all NVRAM variables can affect boot behavior", Remediation: "Do not clear NVRAM", Match: packs.And(packs.Name("nvram"), packs.Flags("-c"))},
			{ID: "nvram-write", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Modifying NVRAM variables can affect boot behavior", Remediation: "Do not write NVRAM variables", Match: packs.And(
				packs.Name("nvram"),
				packs.ArgContentRegex(`=`),
				packs.Not(packs.Or(packs.Flags("-p"), packs.Flags("-x"), packs.Flags("--print"))),
			)},
			{ID: "nvram-delete", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Deleting NVRAM variables can affect boot behavior", Remediation: "Do not delete NVRAM variables", Match: packs.And(packs.Name("nvram"), packs.Flags("-d"))},
			{ID: "spctl-disable", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Disabling Gatekeeper allows unsigned apps", Remediation: "Do not disable Gatekeeper", Match: packs.And(
				packs.Name("spctl"),
				packs.Or(packs.Flags("--master-disable"), packs.Flags("--disable")),
			)},
			{ID: "dscl-delete", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Modifying directory services affects user/group management", Remediation: "Do not modify macOS directory services", Match: packs.And(
				packs.Name("dscl"),
				packs.Or(
			...
			{ID: "fdesetup-disable", Category: evalcore.CategoryBoth, Severity: sevCritical, Confidence: confHigh, Reason: "Disabling/modifying FileVault weakens disk security", Remediation: "Do not modify FileVault settings", Match: packs.And(
				packs.Name("fdesetup"),
			...
			{ID: "systemsetup-modify", Category: evalcore.CategoryBoth, Severity: sevHigh, Confidence: confMedium, Reason: "systemsetup modifies machine-level configuration", Remediation: "Use getter flags for read-only inspection", Match: packs.And(
